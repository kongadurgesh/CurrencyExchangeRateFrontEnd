...
class BarPastWeek extends Component {
				...
				<br></br><br></br>
						...
						<div className="card">
							...
							<div className="card-body">
								...
								<ReactApexChart options={options1.options} series={options1.series} type="bar" height={360} />
							</div>
						</div>
			</div>
		);
